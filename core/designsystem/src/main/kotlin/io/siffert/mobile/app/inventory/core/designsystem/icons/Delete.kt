...
val InventoryIcons.Delete by lazy { InventoryIcons.getDelete(Color.Black) }

@Suppress("UnusedReceiverParameter", "LongMethod")
private fun InventoryIcons.getDelete(iconColor: Color) =
    ImageVector.Builder(
            name = "Delete",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
...
@Preview
@Composable
internal fun DeletePreviewDefault() = Icon(Cozy.icon.Delete, contentDescription = null)
