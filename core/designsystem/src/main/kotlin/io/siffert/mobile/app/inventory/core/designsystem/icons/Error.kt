...
val InventoryIcons.Error by lazy { InventoryIcons.getError(Color.Black) }

@Suppress("UnusedReceiverParameter", "LongMethod")
private fun InventoryIcons.getError(iconColor: Color) =
    ImageVector.Builder(
            name = "Error",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
...
@Preview
@Composable
internal fun ErrorPreviewDefault() = Icon(Cozy.icon.Error, contentDescription = null)
